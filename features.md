...
| Change handle (username)                              | User                                         | Silver, Gold                  |
| Write a professional bio                              | Any User                                     |                               |
| Upload a profile picture                              | User                                         | Silver, Gold                  |
...
| AI-powered resume scoring against job descriptions    | User                                         | Silver, Gold                  |
| Request and store onboarding documents post-offer     | User                                         | Gold                          |
| **Networking & Social**                               |                                              |                               |
| View profiles of other users and companies            | Any User                                     |                               |
| Follow/unfollow other users and companies             | Any User                                     |                               |
| Create posts                                          | User                                         | Free (Limited), Silver, Gold  |
...
| **Intelligence**                                      |                                              |                |
| Add private notes to any Hub User's profile           | Recruiter                                    | Silver+        |
| Use AI-powered search to find candidates              | Recruiter                                    | Gold           |
